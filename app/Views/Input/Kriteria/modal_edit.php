<div class="modal fade" id="modal_edit" tabindex="-1" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open('Kriteria/update', ['class' => 'form_edit']); ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="form-group row">
                    <input type="hidden" name="id_kriteria" id="id_kriteria" value="<?= $id_kriteria; ?>">
                    <input type="hidden" name="slug" id="slug" value="<?= $slug; ?>">
                    <label class="col-sm-4 col-form-label">Nama Kriteria</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_kriteria" name="nama_kriteria" value="<?= $nama_kriteria; ?>">
...
<script>
    document.getElementById('tipe_kriteria').value = "<?= (old('tipe_kriteria')) ? old('tipe_kriteria') : $tipe_kriteria ?>"
    document.getElementById('bobot_kriteria').value = "<?= (old('bobot_kriteria')) ? old('bobot_kriteria') : $bobot_kriteria ?>"
</script>
<script>
